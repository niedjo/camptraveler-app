  ...
  return (
    <section className="flexCenter flex-col">
      <div className="padding-container max-container w-full pd-24">
        ...
        <div className="flex flex-wrap justify-betwen gap-5 lg:gap-10">
          ...
          <div className="flexBetween flex-col ">
            <div className="flex w-full flex-col">
              <div className="flexBetween w-full">
                ...
                <p className='bold-16 text-green-50'>48mn</p>
              </div>
              <p className='bold-20 mt-2'>Aguas Calientes</p>
            </div>
            <div className="flex w-full flex-col">
              <p className='regular-16 text-gray-20'>Start track</p>
              <p className='bold-20 mt-2 whitespace-nowrap'>Wonorejo Pasuruans</p>
            </div>
          </div>
        </div>
      </div>
